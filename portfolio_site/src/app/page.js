  ...
  return (
    <>
      <div className="bg-gray-800">
        <NavBar />
        <div className="flex h-screen items-center pt-32 md:pt-20">
          ...
          shadow-[0_-7px_10px_-1px_rgba(0,0,0,0.1),_0_7px_10px_-1px_rgba(0,0,0,0.1)]">
            <div className="grid border border-dashed rounded-2xl border-zinc-800 bg-zinc-950 justify-center w-full md:w-1/2 px-4 py-10 animate-slideIn bg-opacity-30">
            ...
            <div className="flex justify-center sm:h-32 md:h-96 lg:h-[40rem] w-full md:w-1/2 mt-8 md:mt-0">
